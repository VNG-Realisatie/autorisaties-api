...
MAPPING = BASE_MAPPING + (
    ("authorizations.Autorisatie", "zaaktype", *ZTC),
    ("authorizations.Autorisatie", "informatieobjecttype", *ZTC),
    ("authorizations.Autorisatie", "besluittype", *ZTC),
    ("notifications.Subscription", "callback_url", *AC),
    ("notifications.Subscription", "_subscription", *NRC),
)
