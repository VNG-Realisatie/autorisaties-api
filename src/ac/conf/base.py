...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "ac"),
        "USER": os.getenv("DB_USER", "ac"),
        "PASSWORD": os.getenv("DB_PASSWORD", "ac"),
...
DEFAULT_FROM_EMAIL = "ac@example.com"
EMAIL_TIMEOUT = 10
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": os.path.join(LOGGING_DIR, "ac.log"),
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
