...
os.environ.setdefault(
    "SECRET_KEY", "n&$@jgb^$1jfbw4skz(t83%$o9%+2398-6p%p(!!v8zv@07h_%"
)
os.environ.setdefault("DB_NAME", "ac")
os.environ.setdefault("DB_USER", "ac")
os.environ.setdefault("DB_PASSWORD", "ac")
...
LOGGING["loggers"].update(
    {
        "ac": {"handlers": ["console"], "level": "DEBUG", "propagate": True},
